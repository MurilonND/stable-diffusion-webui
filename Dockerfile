...
# clone another repository, dont seen necessary now
...
# This command executes the clone.sh script with specific parameters, the name of the repository and the branch
RUN . /clone.sh stable-diffusion-stability-ai https://github.com/MurilonND/LiquidArt_AI.git main \
